...
func debugLogQueies(context context.Context, alias *alias, operaton, query string, t time.Time, err error, args ...interface{}) {
...
func (d *stmtQueryLog) Close() error {
	a := time.Now()
	err := d.stmt.Close()
	debugLogQueies(d.context, d.alias, "st.Close", d.query, a, err)
	return err
}
...
func (d *stmtQueryLog) Exec(args ...interface{}) (sql.Result, error) {
	...
	debugLogQueies(d.context, d.alias, "st.Exec", d.query, a, err, args...)
	return res, err
}
...
func (d *stmtQueryLog) Query(args ...interface{}) (*sql.Rows, error) {
	...
	debugLogQueies(d.context, d.alias, "st.Query", d.query, a, err, args...)
	return res, err
}
...
func (d *stmtQueryLog) QueryRow(args ...interface{}) *sql.Row {
	...
	debugLogQueies(d.context, d.alias, "st.QueryRow", d.query, a, nil, args...)
	return res
}
...
func newStmtQueryLogWithContext(context context.Context, alias *alias, stmt stmtQuerier, query string) stmtQuerier {
	d := new(stmtQueryLog)
	d.stmt = stmt
	d.alias = alias
	d.query = query
...
func (d *dbQueryLog) Prepare(query string) (*sql.Stmt, error) {
	...
	debugLogQueies(d.context, d.alias, "db.Prepare", query, a, err)
	return stmt, err
}
...
func (d *dbQueryLog) Exec(query string, args ...interface{}) (sql.Result, error) {
	...
	debugLogQueies(d.context, d.alias, "db.Exec", query, a, err, args...)
	return res, err
}
...
func (d *dbQueryLog) Query(query string, args ...interface{}) (*sql.Rows, error) {
	...
	debugLogQueies(d.context, d.alias, "db.Query", query, a, err, args...)
	return res, err
}
...
func (d *dbQueryLog) QueryRow(query string, args ...interface{}) *sql.Row {
	...
	debugLogQueies(d.context, d.alias, "db.QueryRow", query, a, nil, args...)
	return res
}
...
func (d *dbQueryLog) Begin() (*sql.Tx, error) {
	...
	debugLogQueies(d.context, d.alias, "db.Begin", "START TRANSACTION", a, err)
	return tx, err
}
...
func (d *dbQueryLog) BeginTx(ctx context.Context, opts *sql.TxOptions) (*sql.Tx, error) {
	...
	debugLogQueies(d.context, d.alias, "db.BeginTx", "START TRANSACTION", a, err)
	return tx, err
}
...
func (d *dbQueryLog) Commit() error {
	...
	debugLogQueies(d.context, d.alias, "tx.Commit", "COMMIT", a, err)
	return err
}
...
func (d *dbQueryLog) Rollback() error {
	...
	debugLogQueies(d.context, d.alias, "tx.Rollback", "ROLLBACK", a, err)
	return err
}
...
func newDbQueryLogWithContext(context context.Context, alias *alias, db dbQuerier) dbQuerier {
	d := new(dbQueryLog)
	d.alias = alias
	d.db = db
	d.context = context
