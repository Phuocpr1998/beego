...
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/Phuocpr1998/beego.GoVersion=${go_version[2]:2}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/Phuocpr1998/beego.GitBranch=${CURRENT_BRANCH}"
LD_EXTRAFLAGS="${LD_EXTRAFLAGS} -X github.com/Phuocpr1998/beego.BuildTime=$BUILD_TIME"
